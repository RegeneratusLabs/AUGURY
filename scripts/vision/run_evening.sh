...
echo "=== [1/5] env install (idempotent) ==="
...
echo "=== [3/5] WS1b: DINOv2-base contrastive fine-tune (AU) ==="
...
echo "=== [4/5] re-eval: fine-tuned encoder vs baseline ==="
...
echo "=== [5/5] WS2: formatter LoRA (MiniCPM5-1B) ==="
python - <<'PYEOF'
import re, pathlib
